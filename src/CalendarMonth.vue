...
export default {
	...
	computed: {
		...
		allowLastYearClick() {
			return (
				!this.disablePast || this.aYearBefore(this.displayDate) >= this.today()
			)
		},
		allowNextYearClick() {
			return (
				!this.disableFuture || this.aYearAfter(this.displayDate) <= this.today()
			)
		},
		allowLastMonthClick() {
			return (
				!this.disablePast ||
				this.beginningOfMonth(this.displayDate) > this.today()
			)
		},
		allowNextMonthClick() {
			return (
				!this.disableFuture ||
				this.displayDate < this.beginningOfMonth(this.today())
			)
		},
	},
