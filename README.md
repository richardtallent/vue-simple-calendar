...
* `todayLabel` - Optional string to set the "Today" label at CalendarViewHeader component. Since is in the header props, it can be accessed from the "header" slot.
